  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
        <AdminStatCard icon={<BarChart3 className="h-6 w-6 text-blue-600" />} iconBgColor="bg-blue-50" title="Total" value={stats.total} />
        <AdminStatCard icon={<Bell className="h-6 w-6 text-amber-600" />} iconBgColor="bg-amber-50" title="Nuevas" value={stats.nuevas} />
        <AdminStatCard icon={<EyeIcon className="h-6 w-6 text-sky-600" />} iconBgColor="bg-sky-50" title="Leídas" value={stats.leidas} />
        <AdminStatCard icon={<Phone className="h-6 w-6 text-green-600" />} iconBgColor="bg-green-50" title="Contactadas" value={stats.contactadas} />
        <AdminStatCard icon={<CheckCircle className="h-6 w-6 text-slate-600" />} iconBgColor="bg-gray-100" title="Cerradas" value={stats.cerradas} />
      </div>
          ...
          <>
            {paginatedItems.length === 0 ? (
              <Card className="text-center p-12">
                ...
                <p className="font-medium text-slate-700 mb-1">No hay contactos</p>
                <p className="text-sm text-muted-foreground">No se encontraron contactos con los filtros seleccionados</p>
              </Card>
            ) : (
